...
ovs_D=$(apt --installed list 2>/dev/null | egrep "openvswitch-switch")

if [[ -z "$ovs_D" ]]; then
        echo "============================================================================="
        echo "Installing dependency openvswitch-switch..."
        apt update > /dev/null 2>&1
        apt -y install openvswitch-switch > /dev/null 2>&1
